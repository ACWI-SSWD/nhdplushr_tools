Module RegESRIdll
    ...
    '---------------------------------------------
    ' Program Name  : RegisterNHDPlusHRVaaNavigatorToolBar
    ' Purpose       : Console application called as a custom action during the installation of NHDPlusHRVaaNavigatorToolBar
    '               : used to register NHDPlusHRVaaNavigatorToolBar.dll with ESRIRegAsm.exe
    ...
    Sub Main()
        ...
        Try
            ...
            oStartInfo1.Arguments = strTargetDir & "\NHDPlusHRVAANavigatorToolbar.dll /p:desktop /s"
            ...
            oStartInfo2.Arguments = strTargetDir & "\NHDPlusHRVAANavigator.dll /p:desktop /s"
